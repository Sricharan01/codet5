...
class DatasetLoader(object):
    ...
    def load_llm_preds(self, split):
        ...
        for idx in getattr(self, f'{split}_batch_idxs'):
            ...
            for output in outputs:
                docstring, code = self._parse_llm_output(output)
    ...
    def load_gpt_preds(self, split):
        ...
        for output in outputs:
            docstring, code = self._parse_gpt_output(output)
...
class CQADatasetLoader(DatasetLoader):
    ...
    def _parse_llm_output(self, output):
        docstring_code = output.split('Q:')[0]
        docstring_code = docstring_code.rstrip()
        docstring, code = docstring_code.split('So the answer is')
        docstring = docstring.rstrip()

        try:
            code = re.split(r'\(.\)', code)[1].strip()
    ...
    def _parse_gpt_output(self, output):
        docstring_code = output.split('Q:')[0]
        docstring_code = docstring_code.rstrip().lstrip()
        try:
            docstring, code = docstring_code.split('So the answer is')
            docstring = docstring.rstrip()
        except:
...
class SVAMPDatasetLoader(DatasetLoader):
    ...
    def _parse_llm_output(self, output):
        ...
        docstring_code = docstring_code.rstrip()
        try:
            docstring, code = docstring_code.split('The answer is')
        except:
            docstring = ' '
            code = ' '
            return docstring, code
...
class ESNLIDatasetLoader(DatasetLoader):
    ...
    def _post_process(self, datasets):
        ...
        def prepare_input(example):
            if example['code'] == 0:
                example['code'] = 'entailment'
            elif example['code'] == 1:
                example['code'] = 'neutral'
            elif example['code'] == 2:
    ...
    def _parse_llm_output(self, output):
        docstring = output.split("Answer:")[0].rstrip()
        try:
            code = output.split("Answer: ")[1].split("Premise")[0].rstrip()
        except:
            code = ' '
    ...
    def _parse_gpt_output(self, output):
        docstring = output.split("Answer:")[0].rstrip().lstrip()
        try:
            code = output.split("Answer: ")[1].split("Premise")[0].rstrip()
        except:
            code = ' '
...
class ANLIDatasetLoader(DatasetLoader):
    ...
    def _post_process(self, datasets):
        ...
        datasets = datasets.map(code_idx2text)
    ...
    def _parse_llm_output(self, output):
        try:
            docstring, code = output.split("Premise:")[0].rstrip().split("So the answer is")
        except:
            docstring = ''
            code = ''
    ...
    def _parse_gpt_output(self, output):
        try:
            docstring, code = output.split("Premise:")[0].rstrip().lstrip().split("So the answer is")
        except:
            try:
                docstring, code = output.split("Premise:")[0].rstrip().lstrip().split("The answer is")
            except:
                docstring = ''
                code = ''
